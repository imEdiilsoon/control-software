...
<body>
  <?php 
    ...
    if(isset($_POST['actualizar'])){
      ...
      $actualizar = mysqli_query($conexion, "UPDATE usuarios SET Nombre='$nombre', Sexo='$sexo', NumeroTelefono='$num_telefono', Peso='$peso', Altura='$altura' WHERE Cedula='$id'") or die();
      if($actualizar){
        header("location: mi_perfil.php");
  ...
  <div class="profile-container">
    ...
    <h2><b><?= ucfirst($_SESSION['info']['Nombre']); ?></b></h2>
    <p><b>Correo:</b> <?= $_SESSION['info']['Correo']; ?></p>
    <p><b>Numero de Telefono:</b> <?= ucfirst($_SESSION['info']['NumeroTelefono']); ?></p>
    <p>
      <b>Sexo:</b> <?php 
      if($_SESSION['info']['Sexo'] == "M"){
        echo "Masculino.";
      }   elseif($_SESSION['info']['Sexo'] == "F")  {
        echo "Femenino.";
      }; ?>
    </p>
    <p><b>Peso:</b> <?= ucfirst($_SESSION['info']['Peso']); ?> Kg.</p>
    <p><b>Altura:</b> <?= ucfirst($_SESSION['info']['Altura']); ?> Cm.</p>
