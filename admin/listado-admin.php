...
<body>
    <header>
        ...
        <h3>Bienvenido <?= ucfirst($_SESSION['info']['Nombre']); ?>, Puedes validar y editar la información de los administradores registrados.</h3>
        ...
        <div class="content">
            ...
            <div align="center" class="table-responsive">
                <table align="center" border="1px" class="table table-striped table-hover" style="width: 90%; border-collapse: collapse; border: 2px solid black; text-align: center;">
                    ...
                    $sql = mysqli_query($conexion, "SELECT * FROM administrador");
